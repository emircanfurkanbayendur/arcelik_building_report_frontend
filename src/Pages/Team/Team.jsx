    ...
    <div class="col-md-4 mb-5 mb-md-0">
      <div class="card testimonial-card">
        ...
        <div class="avatar mx-auto bg-white">
          <img src="https://media.licdn.com/dms/image/C5603AQHrM695Opz1SA/profile-displayphoto-shrink_800_800/0/1645609497175?e=2147483647&v=beta&t=3SsVBZfcmJ27oNvBWtqcFMfsAD4CNLh1BLt-Ob2Ie6A"
        ...
        <div class="card-body">
          ...
          <p class="dark-grey-text mt-4">
            <i class="fas fa-quote-left pe-2"></i>Recovery Project - Proje Sorumlusu ve Koordinatörü
          </p>
        </div>
      </div>
    </div>
    <div class="col-md-4 mb-5 mb-md-0">
      <div class="card testimonial-card">
        ...
        <div class="card-body">
          ...
          <hr />
          <p class="dark-grey-text mt-4">
            <i class="fas fa-quote-left pe-2"></i>Recovery Project - Yazılım Geliştirici/Ekip Lideri
          </p>
        </div>
      </div>
    </div>
    <div class="col-md-4 mb-0">
      <div class="card testimonial-card">
        ...
        <div class="card-body">
          ...
          <hr />
          <p class="dark-grey-text mt-4">
            <i class="fas fa-quote-left pe-2"></i>Recovery Project - Yazılım Geliştirici
          </p>
        </div>
      </div>
